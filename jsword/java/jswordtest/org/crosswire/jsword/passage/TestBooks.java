...
public class TestBooks extends TestCase
{
    ...
    public void testCase() throws Exception
    {
        ...
        try { BibleInfo.setCase(Passage.CASE_MIXED); fail(); }
        catch (IllegalArgumentException ex) { }
        try { BibleInfo.setCase(-1); fail(); }
        catch (IllegalArgumentException ex) { }
    }
    ...
    public void testGetLongBookName() throws Exception
    {
        ...
        try { BibleInfo.getShortBookName(67); fail(); }
        catch (NoSuchVerseException ex) { }
    }
    ...
    public void testGetBookNumber() throws Exception
    {
        ...
        try { BibleInfo.getBookNumber("b"); fail(); }
        catch (NoSuchVerseException ex) { }
        try { BibleInfo.getBookNumber("1"); fail(); }
        catch (NoSuchVerseException ex) { }
    }
    ...
    public void testIn() throws Exception
    {
        ...
        for (int b=1; b<=BibleInfo.booksInBible(); b++)
        {
            ...
            int vib = 0;
            for (int c=1; c<=BibleInfo.chaptersInBook(b); c++) vib += BibleInfo.versesInChapter(b, c);
            assertEquals(vib,  BibleInfo.versesInBook(b));

            // Continue the verse counts for the whole Bible
            for (int c=1; c<=BibleInfo.chaptersInBook(b); c++) viw_c += BibleInfo.versesInChapter(b, c);
    ...
    {
        try { BibleInfo.validate(0, 1, 1); fail(); }
        catch (NoSuchVerseException ex) { }
        for (int b=1; b<BibleInfo.booksInBible(); b++)
        {
            try { BibleInfo.validate(b, 0, 1); fail(); }
            catch (NoSuchVerseException ex) { }
            try { BibleInfo.validate(b, 1, 0); fail(); }
            catch (NoSuchVerseException ex) { }

            for (int c=1; c<=BibleInfo.chaptersInBook(b); c++)
            {
                try { BibleInfo.validate(b, c, 0); fail(); }
                catch (NoSuchVerseException ex) { }
                ...
                try { BibleInfo.validate(b, c, BibleInfo.versesInChapter(b, c)+1); fail(); }
                catch (NoSuchVerseException ex) { }
            }

            try { BibleInfo.validate(67, BibleInfo.chaptersInBook(b)+1, 1); fail(); }
            catch (NoSuchVerseException ex) { }
            try { BibleInfo.validate(67, 1, BibleInfo.versesInBook(b)+1); fail(); }
            catch (NoSuchVerseException ex) { }
        }
        try { BibleInfo.validate(67, 1, 1); fail(); }
        catch (NoSuchVerseException ex) { }
    }
