...
public class DebugContainerListener implements ContainerListener
{
    ...
    private void addChild(Container parent, Component child)
    {
        ...
        else
        {
            ...
            {
                log.warn("CL1: child:"+toString(child)+"(cyan), getParent()="+toString(statedParent)+"(green) added under parent="+toString(parent)+"(yellow)", new Exception());
        ...
        if (lastKnownParent != null)
        {
            ...
            {
                log.warn("CL1: child:"+toString(child)+"(blue), altered reparent, old parent="+toString(lastKnownParent)+"(magenta), new parent="+toString(parent)+"(orange)", new Exception());
    ...
    {
        return ClassUtils.getShortClassName(parent, "Null")+"("+parent.hashCode()+")";
    }
