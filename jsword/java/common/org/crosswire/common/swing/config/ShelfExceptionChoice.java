...
* @version D0.I0.T0
*/
public class ShelfExceptionChoice extends BooleanChoice
{
    /**
    ...
    */
    ...
    {
        return ExceptionShelf.getHelpDeskListener();
    }
    ...
    */
    ...
    {
        ExceptionShelf.setHelpDeskListener(value);
    }
    ...
    */
    ...
    {
        return "Do we display Exceptions in a the GUI shelf.";
    }
}
