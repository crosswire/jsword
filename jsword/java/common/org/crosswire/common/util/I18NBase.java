 ...
 * easy for most cases. See { @see org.crosswire.common.util.I18N } for an
 ...
 * @version $Id$
 * @see org.crosswire.common.util.I18N
 */
public class I18NBase extends Enum
{
    /* (non-Javadoc)
     ...
     * Simple ctor
     */
    protected I18NBase(String name)
    {
        super(name);
    }

    protected static ResourceBundle resources;
    protected static Logger log = Logger.getLogger(I18NBase.class);
}
