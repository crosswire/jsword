...
import org.crosswire.common.util.event.LogCaptureListener;
 ...
 * @version D0.I0.T0
 */
public class LogCaptureChoice extends BooleanChoice
{
    /**
    ...
    {
        return LogCaptureListener.getHelpDeskListener();
    }
    ...
    {
        LogCaptureListener.setHelpDeskListener(value);
    }
    ...
    {
        return "Do we log exceptions to the system logger.";
    }
