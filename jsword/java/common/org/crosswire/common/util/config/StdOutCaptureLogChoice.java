 ...
 * @version D0.I0.T0
 */
public class StdOutCaptureLogChoice extends BooleanChoice
{
    /**
    ...
    {
        return StdOutCaptureListener.getHelpDeskLogListener();
    }
    ...
    {
        StdOutCaptureListener.setHelpDeskLogListener(value);
    }
    ...
    {
        return "Do we copy log messages to standard output.";
    }
