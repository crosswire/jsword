...
public class Verify extends HttpServlet {
	...
	public void service(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
		...
		try {
			...
			try {
                String url = "http://www.crosswire.org/sword/download/ftpmirror/pub/sword/"+ ( (beta) ? "betamodules/" : "modules/" )+ pkgType + "/" + modName + ".zip";
			    ...
			    response.getOutputStream().println("<HTML><HEAD><META HTTP-EQUIV=\"Refresh\" CONTENT=\"0;URL="+url+"\"></HEAD><BODY><A HREF="+url+">Click here to download if it doesn't start automatically</A></BODY></HTML>");
