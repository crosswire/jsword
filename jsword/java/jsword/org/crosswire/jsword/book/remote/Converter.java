...
public class Converter
{
     ...
     */
    public static RemoteBibleMetaData[] convertDocumentToBibleMetaDatas(Document doc, RemoteBibleDriver driver) throws MalformedURLException, ParseException
    {
        ...
        for (Iterator it = bmds.iterator(); it.hasNext();)
        {
            ...
            rbmds[i++] = new RemoteBibleMetaData(driver, id, name, edition, initials, pub, open, licence);
        }
