...
* @author Joe Walker
*/
public class SearchException extends LucidException
{
    /**
    ...
    */
    public SearchException(String msg, Object[] params)
    {
        super(msg, params);
    }
    ...
    * @param params An array of parameters
    */
    public SearchException(String msg, Throwable ex, Object[] params)
    {
        super(msg, ex, params);
    }
}
