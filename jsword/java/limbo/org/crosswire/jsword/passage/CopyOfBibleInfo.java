 ...
 */
public class CopyOfBibleInfo
{
    /**
     * Ensure that we can not be instantiated
     */
    private CopyOfBibleInfo()
    {
        initialize();
    }
    ...
    private static void initialize()
    {
        ...
        ResourceBundle resources = ResourceBundle.getBundle(CopyOfBibleInfo.class.getName(), Locale.getDefault(), new CWClassLoader(CopyOfBibleInfo.class));

        for (int i = 0; i < CopyOfBibleInfo.BOOKS_IN_BIBLE; i++)
        {
        ...
        resources = ResourceBundle.getBundle(OSIS_PROPERTIES, Locale.getDefault(), new CWClassLoader(CopyOfBibleInfo.class));
    ...
    {
        CopyOfBibleInfo.bookCase = CaseType.fromInteger(bookCase);
    }
     ...
     * @see Passage
     * @see CopyOfBibleInfo#setCase(CaseType)
     */
    public static final int getCase()
    {
        return CopyOfBibleInfo.bookCase.toInteger();
    }
    ...
    public static final void setCase(CaseType newBookCase)
    {
        ...
        CopyOfBibleInfo.bookCase = newBookCase;
    }
     ...
     * @return The current case setting
     * @see Passage
     * @see CopyOfBibleInfo#setCase(int)
     */
    public static final CaseType getDefaultCase()
    {
        return CopyOfBibleInfo.bookCase;
    }
    ...
    {
        if (ordinal < 1 || ordinal > CopyOfBibleInfo.versesInBible())
        {
            Object[] params = new Object[] { new Integer(CopyOfBibleInfo.versesInBible()), new Integer(ordinal) };
        ...
        for (int b = BOOKS_IN_BIBLE; b > 0; b--)
        {
            ...
            {
                int cib = CopyOfBibleInfo.chaptersInBook(b);
                for (int c = cib; c > 0; c--)
                {
     ...
     */
    protected static final CopyOfBibleInfo instance = new CopyOfBibleInfo();
