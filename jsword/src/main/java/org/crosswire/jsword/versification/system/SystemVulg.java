...
public class SystemVulg extends Versification {
    ...
    public static int[][] lastVerseNT =
    {
        ...
        // John
        {
               51,    25,    36,    54,    47,    72,    53,    59,    41,
               42,    57,    50,    38,    31,    27,    33,    26,    40,    42,
               31,    25,
        },
        // Acts
        {
               26,    47,    26,    37,    42,    15,    59,    40,    43,
    ...
    public static int[][] lastVerseOT =
    {
        ...
        // Joshua
        {
               18,    24,    17,    25,    16,    27,    26,    35,    27,
               43,    23,    24,    33,    15,    63,    10,    18,    28,    51,
                9,    43,    34,    16,    33,
        },
        // Judges
        {
               36,    23,    31,    24,    32,    40,    25,    35,    57,
        ...
        // Nehemiah
        {
               11,    20,    31,    23,    19,    19,    73,    18,    38,
               39,    36,    46,    31,
        },
        // Tobit
        {
               25,    23,    25,    23,    28,    22,    20,    24,    12,
               13,    21,    22,    23,    17,
        },
        // Judith
        {
               12,    18,    15,    17,    29,    21,    25,    34,    19,
        ...
        // Wisdom
        {
               16,    25,    19,    20,    24,    27,    30,    21,    19,
               21,    27,    27,    19,    31,    19,    29,    20,    25,    20,
        },
        // Sirach
        {
               40,    23,    34,    36,    18,    37,    40,    22,    25,
