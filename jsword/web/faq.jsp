...
<p>
Currently the core Bible view functions work fine, and we are working 
...
is available in CVS right now.
</p>

<h3>How similar is the Java Sword API to the C++ Sword API?</h3>
<p>
It depends on your perspective! The core Java API is similar in that 
...
tree tries to mimic the C++ wherever possible.
</p>

<h3>Why not make the C++ Sword API the primary API?</h3>
<p>
There are a number of problems with language independant APIs. They 
