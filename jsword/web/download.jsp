...
<h1>Download</h1>
<jsp:scriptlet><![CDATA[
  String nightlydir = application.getInitParameter("nightly-dir");
  String releasedir = application.getInitParameter("release-dir");
  String webdlprefix = application.getInitParameter("web-dl-prefix");
  if (nightlydir == null)
  	throw new NullPointerException("nightlydir");
  if (releasedir == null)
  	throw new NullPointerException("releasedir");
  if (webdlprefix == null)
  	throw new NullPointerException("webdlprefix");
]]></jsp:scriptlet>
<h3>Official Releases</h3>
<p>
The first beta release is due out very soon, pending completion of the
Sword drivers.
</p>
