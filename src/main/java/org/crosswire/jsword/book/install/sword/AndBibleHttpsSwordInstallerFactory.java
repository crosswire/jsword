 ...
 */
public class AndBibleHttpsSwordInstallerFactory extends HttpSwordInstallerFactory {
    /*
     * (non-Javadoc)
     * 
    ...
    public Installer createInstaller() {
        return new AndBibleHttpsSwordInstaller();
    }
    ...
    private Installer createInstaller(String[] parts) {
        AbstractSwordInstaller reply = new AndBibleHttpsSwordInstaller();
