...
public abstract class AbstractPassageBook extends AbstractBook {
    ...
    private String toString(Set<BibleBook> bibleBooks) {
        StringBuilder sb = new StringBuilder(bibleBooks.size() * 8);
    ...
    private Set<BibleBook> calculateBibleBookList() {
        ...
        final Versification v11n = Versifications.instance().getVersification((String) bookMetaData.getProperty(BookMetaData.KEY_VERSIFICATION));
